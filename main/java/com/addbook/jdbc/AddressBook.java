...
public class AddressBook {
	...
	private void writeData() throws IOException, CsvDataTypeMismatchException, CsvRequiredFieldEmptyException {
		...
		contactList.add(
				new Contact("srujan", "konda", "hnk", "wgl", "telangana", "563781", "6474781891", "xyz.abc@gmail.com"));
		contactList.add(new Contact("abc", "xyz", "bankcolony", "karimnagar", "telangana", "746387", "875833748",
				"wgl.tlgna@gmail.com"));
