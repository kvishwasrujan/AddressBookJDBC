...
public class AddressBookJson {
	public static String HOME_JSON = "C:\\Users\\.eclipse\\org.eclipse.tips.state\\com.addbook.jdbc\\json.txt";
	...
	private void writeDataJson() throws IOException {
		...
		contactList.add(new Contact("sheldon", "Cooper", "caltech", "texas", "usa", "758242", "8983938163",
				"sheldoncooper@gmail.com"));
		contactList.add(
				new Contact("penny", "tbbt", "factory", "texas", "usa", "828422", "4792839839", "penny@gmail.com"));
		contactList.add(new Contact("lenoard", "hofsdater", "caltech", "texas", "usa", "823939", "24834743681",
				"lenoardhofsdater@gmail.com"));
